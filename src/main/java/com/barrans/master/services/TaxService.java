...
public class TaxService implements IAction {
	...
	public SimpleResponse inquiry(Object param) {
		try {
			...
			String description = req.get("description") == null ? GeneralConstants.EMPTY_STRING : req.get("description").toString();
			...
			List<Map<String, Object>> data = BasicUtils.createListOfMapFromArray(
					list, "id", "isActive", "description", "rate", "type");
	...
	public SimpleResponse entity(Object param) {
		...
		try {
			...
			sb.append("select id, is_active, description, rate, \"type\" from master_schema.tax where id =: paramId");
