...
@ApplicationScoped
public class ChartOfAccountTypeService implements IAction {
	private static final Logger LOGGER = LoggerFactory.getLogger(ChartOfAccountTypeService.class.getName());
	@Inject
	EntityManager em;
